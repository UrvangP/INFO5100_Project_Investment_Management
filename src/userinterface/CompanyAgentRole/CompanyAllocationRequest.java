 ...
 * @author urvang
 */
public class CompanyAllocationRequest extends javax.swing.JPanel {

    /**
     * Creates new form CompanyAllocationRequest
     */
    EcoSystem ecosystem;
    UserAccount account;
    ...
    public CompanyAllocationRequest(EcoSystem ecosystem, UserAccount account) {
    ...
    public void getStatus() {
        ...
        for (int i = 0; i < this.ecosystem.getWorkQueue().getWorkRequestList().size(); i++) {
            ...
            if (ongoing instanceof StockBuyWorkQueue) {
                ...
                if (temp.getRaisedTo() == this.account && temp.getStatusType() == StockBuyWorkQueue.StatusType.Initiated) {
                ...
                if (temp.getRaisedTo() == this.account && temp.getStatusType() == StockSellWorkRequest.StatusType.Initiated) {
                    allRequests.add(temp);
                    Object[] row = {
                        "SELL",
                        temp.getCompanyName(),
