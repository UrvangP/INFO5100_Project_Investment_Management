 ...
 * @author urvang
 */
public class CustomerCryptoMarketJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CustomerCryptoMarketJPanel
     */
    ...
    public CustomerCryptoMarketJPanel(EcoSystem ecosystem, UserAccount account, JSplitPane jSplitPane, Network selectedNetwork) {
        this.jSplitPane = jSplitPane;
        this.account = account;
        this.ecosystem = ecosystem;
        this.selectedNetwork = selectedNetwork;
        initComponents();
        CustomerCryptoMarketHome customerAssetViewOrderJPanel = new CustomerCryptoMarketHome(this.ecosystem, account, selectedNetwork);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        CustomerCryptoCreateOrderJPanel customerAssetViewOrderJPanel = new CustomerCryptoCreateOrderJPanel(this.ecosystem, account, jSplitPane1, selectedNetwork);
        this.jSplitPane1.setRightComponent(customerAssetViewOrderJPanel);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        this.jSplitPane1.setRightComponent(customerCreateOrderJPanel);
    }//GEN-LAST:event_jLabel1MouseClicked

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        CustomerCryptoRequestHistory customerRequestViewJPanel = new CustomerCryptoRequestHistory(this.ecosystem, account, jSplitPane, selectedNetwork);
        this.jSplitPane1.setRightComponent(customerRequestViewJPanel);
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        CustomerCryptoSell customerRequestSellJPanel = new CustomerCryptoSell(this.ecosystem, account, jSplitPane, selectedNetwork);
