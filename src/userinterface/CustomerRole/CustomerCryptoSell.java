 ...
 * @author urvang
 */
public class CustomerCryptoSell extends javax.swing.JPanel {

    /**
     * Creates new form CustomerCryptoSell
     */
    JSplitPane jSplitPane;
    UserAccount account;
    EcoSystem ecosystem;
    Network selectedNetwork;
    CryptoBuyWorkRequest selectedRequest;
    ArrayList<CryptoBuyWorkRequest> allRequests = new ArrayList<>();

    public CustomerCryptoSell(EcoSystem ecosystem, UserAccount account, JSplitPane jSplitPane, Network selectedNetwork) {
    ...
    public void getData() {
        ...
        for (int i = 0; i < this.ecosystem.getWorkQueue().getWorkRequestList().size(); i++) {
            ...
            if (ongoing instanceof CryptoBuyWorkRequest) {
                ...
                if (temp.getStatusType() == CryptoBuyWorkRequest.StatusType.Completed) {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        CryptoSellWorkRequest newRequest = new CryptoSellWorkRequest(
            ...
            new Date(),
            null,
            CryptoSellWorkRequest.StatusType.Initiated,
