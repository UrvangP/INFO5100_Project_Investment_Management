 ...
 * @author urvang
 */
public class CustomerCryptoMarketHome extends javax.swing.JPanel {

    /**
     * Creates new form CustomerCryptoMarketHome
     */
    EcoSystem ecosystem;
    UserAccount account;
    Network ongoing;
    
    public CustomerCryptoMarketHome(EcoSystem ecosystem, UserAccount account, Network ongoing) {
