 ...
 */
public class DeliveryManAdminJPanel extends javax.swing.JPanel {

    JPanel rootJPanel;
    UserAccount account;
    EcoSystem system;

    public DeliveryManAdminJPanel(JPanel rootJPanel, UserAccount account, EcoSystem system) {
        initComponents();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        DeliveryManDashboardJPanel createAdmin = new DeliveryManDashboardJPanel(this.system, account, jSplitPane);
